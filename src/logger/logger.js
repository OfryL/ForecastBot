...
Logger.prototype.log = function (message, ...optionalParams) {
  sysLogger.log(
    getFormatHeader(this.loggerName, style.info.title, style.info.colorCode) + message,
    ...optionalParams,
  );
};
...
Logger.prototype.warn = function (message, ...optionalParams) {
  sysLogger.warn(
    getFormatHeader(this.loggerName, style.warn.title, style.warn.colorCode) + message,
    ...optionalParams,
  );
};
...
Logger.prototype.error = function (message, ...optionalParams) {
  sysLogger.error(
    getFormatHeader(this.loggerName, style.error.title, style.error.colorCode) + message,
    ...optionalParams,
  );
};
...
Logger.prototype.debug = function (message, ...optionalParams) {
  this.debugger(
    getFormatHeader(this.loggerName, style.debug.title, style.debug.colorCode) + message,
    ...optionalParams,
  );
};
